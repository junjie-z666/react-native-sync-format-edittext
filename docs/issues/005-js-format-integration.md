...
- [ ] 传入 format 函数后，用户输入自动被格式化
- [ ] 电话号码格式化示例：输入 "13812345678" 显示 "138-1234-5678"
- [ ] 光标位置正确（跟随格式化后的 cursorPos）
- [ ] 不传 format prop 时，组件正常工作（不做格式化）
- [ ] format 函数返回的 text 和 cursorPos 都被正确应用
